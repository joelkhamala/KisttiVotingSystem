    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="index.php" class="navbar-brand headerFont text-lg">eVoting</a>
        </div>
...
return $data;
	...
	if($rows==1)
	{
		...
		$sql="UPDATE tbl_admin SET admin_password='$new' WHERE admin_username='admin'"; // =============EDIT *SESSSION_SUERNAME *
