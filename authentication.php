    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="index.php" class="navbar-brand text-lg">Kisiwa TTI Students Voting System</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="example-nav-collapse">
          ...
          <button type="submit" class="btn btn-success navbar-right navbar-btn"><span class="normalFont"><strong><a href="admin.php">Admin Panel</a></strong></span></button>
        </div>
